...
console.log(
  ...
  if(wersja === "standardowa") {
    measureExecutionTime(mainPage, 20, "mainPage()");
    measureExecutionTime(oNasPage, 20, "oNasPage()");
    measureExecutionTime(kontaktPage, 20, "kontaktPage()");
  } else {
    measureExecutionTime(new_mainPage, 20, "new_mainPage()");
  measureExecutionTime(new_oNasPage, 20, "new_oNasPage()");
  measureExecutionTime(new_kontaktPage, 20, "new_kontaktPage()");
  }
}
